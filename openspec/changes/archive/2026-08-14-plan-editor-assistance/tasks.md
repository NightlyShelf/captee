...
- [x] 7.4 Manually verify keyboard-only completion, accessible diagnostic feedback, large project-tree scrolling, command placement, About dialog, and clean restart after Save and Discard exits.
