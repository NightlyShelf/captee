...
- [ ] 4.1 Add concrete portal/fallback capture adapters for the supported Linux desktop path and wire Capture cancellation/error completion.
...
- [ ] 5.1 Add settings UI and persistence for formatting, capture fallback, preview preferences, and keybindings using existing validation.
